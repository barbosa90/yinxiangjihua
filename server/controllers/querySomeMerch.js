...
var getMerchDetail = (params) => {
  return new Promise((resolve, reject) => {
    ...
    var queryString = 'SELECT a.*,Graphs.graph_blob FROM (SELECT distinct Merchandise.*, Merch_content.merchid,Merch_content.graphid FROM Merchandise ,Merch_content where Merchandise.id = Merch_content.merchid) a LEFT JOIN Graphs ON Graphs.id = a.graphid ORDER BY showTime LIMIT ?,?;'
