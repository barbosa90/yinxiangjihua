...
var getMerchDetail = (params) => {
  return new Promise((resolve, reject) => {
    ...
    var queryString = 'SELECT a.*,Graphs.graph_blob FROM (SELECT distinct Merchandise.*, Merch_content.merchid,Merch_content.list FROM Merchandise ,Merch_content WHERE Merch_content.list is not null AND Merchandise.id = Merch_content.merchid) a LEFT JOIN Graphs ON Graphs.id = a.list ORDER BY showTime LIMIT ?,?;'
